-- Table movie
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Побег из Шоушенка', 'The Shawshank Redemption', date'1994-01-01', 'Успешный банкир Энди Дюфрейн обвинен в убийстве собственной жены и ее любовника. Оказавшись в тюрьме под названием Шоушенк, он сталкивается с жестокостью и беззаконием, царящими по обе стороны решетки. Каждый, кто попадает в эти стены, становится их рабом до конца жизни. Но Энди, вооруженный живым умом и доброй душой, отказывается мириться с приговором судьбы и начинает разрабатывать невероятно дерзкий план своего освобождения.', 8.9, 123.45,
'https://m.media-amazon.com/images/I/81ScTKtWJrL._AC_SY679_.jpg');
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Зеленая миля', 'The Green Mile', date'1999-01-01', 'Обвиненный в страшном преступлении, Джон Коффи оказывается в блоке смертников тюрьмы «Холодная гора». Вновь прибывший обладал поразительным ростом и был пугающе спокоен, что, впрочем, никак не влияло на отношение к нему начальника блока Пола Эджкомба, привыкшего исполнять приговор.', 8.9, 134.67,
...
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Список Шиндлера', 'Schindler''s List', date'1993-01-01', 'Фильм рассказывает реальную историю загадочного Оскара Шиндлера, члена нацистской партии, преуспевающего фабриканта, спасшего во время Второй мировой войны почти 1200 евреев.', 8.7, 150.50,
...
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('1+1', 'INTOuchables', date'2011-01-01', 'Пострадав в результате несчастного случая, богатый аристократ Филипп нанимает в помощники человека, который менее всего подходит для этой работы, — молодого жителя предместья Дрисса, только что освободившегося из тюрьмы. Несмотря на то, что Филипп прикован к инвалидному креслу, Дриссу удается привнести в размеренную жизнь аристократа дух приключений.', 8.3, 120.00,
...
'https://m.media-amazon.com/images/I/51QRZfDeOrL._AC_.jpg');
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Титаник', 'Titanic', date'1997-01-01', 'Молодые влюбленные Джек и Роза находят друг друга в первом и последнем плавании «непотопляемого» Титаника. Они не могли знать, что шикарный лайнер столкнется с айсбергом в холодных водах Северной Атлантики, и их страстная любовь превратится в схватку со смертью…', 7.9, 150.00,
...
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Темный рыцарь', 'The Dark Knight', date'2008-01-01', 'Бэтмен поднимает ставки в войне с криминалом. С помощью лейтенанта Джима Гордона и прокурора Харви Дента он намерен очистить улицы от преступности, отравляющей город. Сотрудничество оказывается эффективным, но скоро они обнаружат себя посреди хаоса, развязанного восходящим криминальным гением, известным испуганным горожанам под именем Джокер.', 8.5, 199.99,
...
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Хороший, плохой, злой', 'Il buono, il brutto, il cattivo', date'2008-01-01', 'В разгар гражданской войны таинственный стрелок скитается по просторам Дикого Запада. У него нет ни дома, ни друзей, ни компаньонов, пока он не встречает двоих незнакомцев, таких же безжалостных и циничных. По воле судьбы трое мужчин вынуждены объединить свои усилия в поисках украденного золота. Но совместная работа — не самое подходящее занятие для таких отъявленных бандитов, как они. Компаньоны вскоре понимают, что в их дерзком и опасном путешествии по разоренной войной стране самое важное — никому не доверять и держать пистолет наготове, если хочешь остаться в живых.', 8.5, 130.00,
...
INSERT INTO movieland.movie (name, original_name,  year_release, description, rating, price, poster_url)
VALUES('Джанго освобожденный', 'Django Unchained', date'2012-01-01', 'Эксцентричный охотник за головами, также известный как «Дантист», промышляет отстрелом самых опасных преступников. Работенка пыльная, и без надежного помощника ему не обойтись. Но как найти такого и желательно не очень дорогого? Беглый раб по имени Джанго — прекрасная кандидатура. Правда, у нового помощника свои мотивы — кое с чем надо разобраться…', 8.5, 170.00,
...
-- Table user
INSERT INTO movieland.user(name, email, password)
VALUES('Рональд Рейнольдс', 'ronald.reynolds66@example.com', CRYPT('paco', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Дарлин Эдвардс', 'darlene.edwards15@example.com', CRYPT('bricks', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Габриэль Джексон', 'gabriel.jackson91@example.com', CRYPT('hjkl', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Дэрил Брайант', 'daryl.bryant94@example.com', CRYPT('exodus', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Нил Паркер', 'neil.parker43@example.com', CRYPT('878787', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Трэвис Райт', 'travis.wright36@example.com', CRYPT('smart', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Амелия Кэннеди', 'amelia.kennedy58@example.com', CRYPT('beaker', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Айда Дэвис', 'ida.davis80@example.com', CRYPT('pepsi1', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Джесси Паттерсон', 'jessie.patterson68@example.com', CRYPT('tommy', gen_salt('bf')));
INSERT INTO movieland.user(name, email, password)
VALUES('Деннис Крейг', 'dennis.craig82@example.com', CRYPT('coldbeer', gen_salt('bf')));
...
-- Table country
INSERT INTO movieland.country (name) VALUES('США');
INSERT INTO movieland.country (name) VALUES('Франция');
INSERT INTO movieland.country (name) VALUES('Великобритания');
INSERT INTO movieland.country (name) VALUES('Италия');
INSERT INTO movieland.country (name) VALUES('Германия');
INSERT INTO movieland.country (name) VALUES('Япония');
INSERT INTO movieland.country (name) VALUES('Испания');